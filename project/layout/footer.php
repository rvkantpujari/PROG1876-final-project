<footer class="text-gray-600 body-font px-8">
    <div class="container px-4 mx-auto flex items-center sm:flex-row flex-col">
        <a class="flex title-font font-medium items-center justify-center md:justify-start text-gray-900">
            ...
            </svg><span class="ml-3 text-xl">Enroll</span></span>
        </a>
