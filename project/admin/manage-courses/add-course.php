                        ...
                        <div class="rounded-lg bg-white p-8 shadow-lg lg:col-span-4 lg:p-12">
                            <form class="grid grid-cols-8 gap-4">
                                <div class="col-span-full md:col-span-2">
                                    ...
                                    <input class="w-full mt-2 rounded-lg border border-gray-300 p-3 text-md" placeholder="Course ID" type="text" id="course_id"/>
                                </div>

                                <div class="col-span-full md:col-span-4">
                                    <label class="text-sm text-gray-500" for="course_title">Course Title</label>
                                    <input class="w-full mt-2 rounded-lg border border-gray-300 p-3 text-md" placeholder="Course Title" type="text" id="course_title"/>
                                </div>

                                <div class="col-span-full md:col-span-2">
                                    <label class="text-sm text-gray-500" for="course_credits">Course Credits</label>
                                    <input class="w-full mt-2 rounded-lg border border-gray-300 p-3 text-md" placeholder="Course Credits" type="text" id="course_credits"/>
                                </div>

                                <div class="col-span-full">
                                    <label class="text-sm text-gray-500" for="coruse_desc">Course Description</label>
                                    <textarea class="w-full mt-2 rounded-lg border border-gray-300 p-3 text-md" placeholder="Description" rows="5" id="course_desc"></textarea>
                                </div>

                                <div class="col-span-full mt-4 flex justify-between md:justify-start">
                                    <button type="submit" class="btn inline-block rounded-lg bg-black mt-4 px-4 py-2 font-medium text-white sm:w-auto">Add Course</button>
