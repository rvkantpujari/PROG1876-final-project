                ...
                <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
                        ...
                        <div class="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12">
                            <form class="grid grid-cols-8 gap-4" id="editCourseForm">
                                <div class="col-span-full md:col-span-2">
                                    <label class="text-sm text-gray-500" for="course_id">Course ID</label>
                                    <input class="w-full mt-2 rounded-lg border border-gray-300 p-3 text-md" value="<?php echo $record[0]['course_id']; ?>" placeholder="Course ID" type="text" name="course_id" id="course_id" readonly/>
                                </div>

                                <div class="col-span-full md:col-span-4">
                                    <label class="text-sm text-gray-500" for="course_title">Course Title</label>
                                    <input class="w-full mt-2 rounded-lg border border-gray-300 p-3 text-md" value="<?php echo $record[0]['course_title']; ?>" placeholder="Course Title" type="text" name="course_title" id="course_title"/>
                                </div>

                                <div class="col-span-full md:col-span-2">
                                    <label class="text-sm text-gray-500" for="course_credits">Course Credits</label>
                                    <input class="w-full mt-2 rounded-lg border border-gray-300 p-3 text-md" value="<?php echo $record[0]['course_credits']; ?>" placeholder="Course Credits" type="text" name="course_credits" id="course_credits"/>
                                </div>
                                
                                <div class="col-span-full">
                                    <label class="text-sm text-gray-500" for="coruse_desc">Course Description</label>
                                    <textarea class="w-full mt-2 rounded-lg border border-gray-300 p-3 text-md" placeholder="Description" rows="8" name="course_desc" id="course_desc"><?php echo $record[0]['course_desc']; ?></textarea>
                                </div>
